...
const test1 = deepCompareArrays(['cotton', 'wool', 'pleather'], sofas);
console.assert(test1, 'Test 1');

sofas[1] = 'plaid';

const test2 = deepCompareArrays(['wood', 'metal', 'plastic'], tables);
console.assert(test2, 'Test 2');

const test3 = deepCompareArrays(['cotton', 'plaid', 'pleather'], sofas);
console.assert(test3, 'Test 3');

tables.shift();

const test4 = deepCompareArrays(['metal', 'plastic'], tables);
