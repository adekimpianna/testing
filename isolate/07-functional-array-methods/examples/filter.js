<<<<<<< HEAD:isolate/6-array-methods/examples/filter.js
'use strict';
...
const _1_arg = [];
const _1_expect = [];
const _1_test = deepCompare(_1_arg.filter(isEnthusiastic), _1_expect) ? 'pass' : 'fail';
console.assert(_1_test, 'Test 1');

// filters everything when there are no enthusiastic strings
const _2_arg = ['', ':)', 'tree'];
const _2_expect = [];
const _2_test = deepCompare(_2_arg.filter(isEnthusiastic), _2_expect) ? 'pass' : 'fail';
console.assert(_2_test, 'Test 2');

// keeps everything when there are only enthusiastic strings
const _3_arg = ['! :(', 'hi!', '!?'];
const _3_expect = ['! :(', 'hi!', '!?'];
const _3_test = deepCompare(_3_arg.filter(isEnthusiastic), _3_expect) ? 'pass' : 'fail';
console.assert(_3_test, 'Test 3');

// works with a mixed array
const _4_arg = [':(', 'hi!', '!', ''];
const _4_expect = ['hi!', '!'];
const _4_test = deepCompare(_4_arg.filter(isEnthusiastic), _4_expect) ? 'pass' : 'fail';
...
>>>>>>> 889bbdf9d5637c41df698fae66c51736d013e2ed:isolate/07-functional-array-methods/examples/filter.js
